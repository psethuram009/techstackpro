...
app.get("/filter",(req,res)=>{
  ...
  const filteredjoke= jokes.filter((joke)=>joke.jokeType===type)//filter is used iterate throgh an array and retrun back an array
...
app.put("/jokes/:id",(req,res)=>{
  ...
  jokes[searchJoke]=replacementJoke;//It replaces the existing joke in the jokes array at the found index (searchJoke) with the replacementJoke.
